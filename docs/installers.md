...
```powershell
powershell -ExecutionPolicy Bypass -c '$s = irm ''https://raw.githubusercontent.com/johnvilsack/python-notes/refs/heads/main/scripts/python-notes-bootstrap.ps1''; iex $s; Start-PythonNotesBootstrap -WhatIf -Verbose -LogFile "$env:USERPROFILE\github\python-notes-bootstrap.log"'
```
