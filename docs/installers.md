...
```powershell
powershell -ExecutionPolicy Bypass -c "irm 'https://raw.githubusercontent.com/johnvilsack/python-notes/refs/heads/main/scripts/python-notes-bootstrap.ps1' | iex; Start-PythonNotesBootstrap -WhatIf -Verbose -LogFile "%USERPROFILE%\git\python-notes-bootstrap.log"
```
<br>
